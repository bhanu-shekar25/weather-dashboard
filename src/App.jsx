      ...
      <Container>
        ...
        <Box sx={{ display: 'flex', gap: 2, mb: 2 }}>
          <TextField
            ...
            fullWidth
          />
          <Button variant="contained" onClick={handleAddCity}>Search</Button>
        </Box>
        ...
        {weatherData.map((weather, idx) => (
          <Box key={idx} className={`weather-bg ${weather.weather[0].main.toLowerCase()}`} sx={{ p: 2, mb: 4, borderRadius: 2 }}>
            <WeatherCard
              weather={weather}
              unit={unit}
